      ...
      <section className='text-gray-700 border-t border-gray-200'>
        <div className='container px-5 py-24 mx-auto'>
          <div className='text-center mb-20'>
            ...
            <p>フロントエンド言語 JavaScript,React,TypeScriptなどを学習しています。高校卒業後に株式会社アイシンに入社後に現在に至るまで、アルミダイカスト製品の品質管理の業務を担当しています。2019年からフロントエンドの言語に興味を持ち、独学での学習をスタートする。2021年4月からIT分野の知見を広げるために東京通信大学 情報マネジメント学部に入学。現職の仕事をしながら、学習を進めています。</p>
          </div>
          {/* カードのdivタグ */}
